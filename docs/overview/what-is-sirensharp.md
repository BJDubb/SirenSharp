...
SirenSharp is a desktop tool for generating FiveM resources that stream custom server-sided siren audio to clients.
...
* Automatic WAV sanitization (mono 16-bit PCM, junk header stripping)
* Post-generation AWC verification (catches silent ~1 KB files)
